...
var getValOfIdentifier = function (id, varTable) {
    return (varTable.length == 0 || code_substitutor_1.isVarParam(id, varTable, varTable.length > 0) ? id.name : exports.getValOfValExp(code_substitutor_1.getValueExpressionOfIdentifier(id, varTable, varTable.length > 0), varTable));
};
